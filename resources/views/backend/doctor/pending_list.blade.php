            ...
            <div class="col-md-12 table-responsive card">
                <div class="data-tables">
                    <div class="card-body table-striped table-no-bordered table-hover dataTable dtr-inline table-full-width">
                        ...
                        <div class="fresh-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover table-responsive container" cellspacing="0" width="100%" style="width:100%">
                                <thead>
                                <tr>
                                    <th>S/N</th>
                                    <th>Name</th>
                                ...
                                @php
                                $appointment = \App\Models\Appointment::orderBy('date', 'desc')->orderby('id', 'desc')->where('status', '0')->where('departments_id',auth()->user()->departments_id)->get();
